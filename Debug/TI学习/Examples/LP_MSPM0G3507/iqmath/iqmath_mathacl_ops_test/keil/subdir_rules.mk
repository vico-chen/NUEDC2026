...
TI学习/Examples/LP_MSPM0G3507/iqmath/iqmath_mathacl_ops_test/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/iqmath/iqmath_mathacl_ops_test/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
