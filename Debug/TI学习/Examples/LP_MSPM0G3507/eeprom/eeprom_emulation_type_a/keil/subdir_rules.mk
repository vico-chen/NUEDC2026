...
TI学习/Examples/LP_MSPM0G3507/eeprom/eeprom_emulation_type_a/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/eeprom/eeprom_emulation_type_a/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
