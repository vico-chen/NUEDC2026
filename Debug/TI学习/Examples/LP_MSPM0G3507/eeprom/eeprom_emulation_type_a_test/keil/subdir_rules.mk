...
TI学习/Examples/LP_MSPM0G3507/eeprom/eeprom_emulation_type_a_test/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/eeprom/eeprom_emulation_type_a_test/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
