...
TI学习/Examples/LP_MSPM0G3507/cmsis_dsp/cmsis_dsp_empty/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/cmsis_dsp/cmsis_dsp_empty/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
