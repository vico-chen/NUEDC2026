...
TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_hfxt_run/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_hfxt_run/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
