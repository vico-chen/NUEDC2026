...
TI学习/Examples/LP_MSPM0G3507/driverlib/mcan_message_rx/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/mcan_message_rx/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
