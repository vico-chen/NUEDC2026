...
TI学习/Examples/LP_MSPM0G3507/driverlib/opa_inverting_pga_with_dac/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/opa_inverting_pga_with_dac/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
