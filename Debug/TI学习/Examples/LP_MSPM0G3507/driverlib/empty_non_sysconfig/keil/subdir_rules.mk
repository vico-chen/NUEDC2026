...
TI学习/Examples/LP_MSPM0G3507/driverlib/empty_non_sysconfig/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/empty_non_sysconfig/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
