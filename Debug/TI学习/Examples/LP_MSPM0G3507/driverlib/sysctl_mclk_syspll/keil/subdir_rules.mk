...
TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_mclk_syspll/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_mclk_syspll/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
