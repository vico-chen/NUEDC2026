...
TI学习/Examples/LP_MSPM0G3507/driverlib/spi_controller_repeated_fifo_dma_interrupts/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/spi_controller_repeated_fifo_dma_interrupts/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
