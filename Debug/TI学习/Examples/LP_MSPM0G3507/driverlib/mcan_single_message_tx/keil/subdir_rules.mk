...
TI学习/Examples/LP_MSPM0G3507/driverlib/mcan_single_message_tx/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/mcan_single_message_tx/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
