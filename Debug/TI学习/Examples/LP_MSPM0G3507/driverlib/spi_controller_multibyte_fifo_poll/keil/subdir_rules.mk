...
TI学习/Examples/LP_MSPM0G3507/driverlib/spi_controller_multibyte_fifo_poll/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/spi_controller_multibyte_fifo_poll/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
