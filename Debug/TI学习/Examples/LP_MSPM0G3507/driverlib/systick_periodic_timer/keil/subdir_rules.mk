...
TI学习/Examples/LP_MSPM0G3507/driverlib/systick_periodic_timer/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/systick_periodic_timer/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
