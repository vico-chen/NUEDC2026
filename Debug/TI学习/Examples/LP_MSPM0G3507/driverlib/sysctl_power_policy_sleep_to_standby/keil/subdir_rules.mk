...
TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_power_policy_sleep_to_standby/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_power_policy_sleep_to_standby/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
