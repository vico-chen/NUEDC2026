...
TI学习/Examples/LP_MSPM0G3507/driverlib/i2c_controller_rw_repeated_start_fifo_interrupts/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/i2c_controller_rw_repeated_start_fifo_interrupts/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
