...
TI学习/Examples/LP_MSPM0G3507/driverlib/gpio_input_capture/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/gpio_input_capture/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
