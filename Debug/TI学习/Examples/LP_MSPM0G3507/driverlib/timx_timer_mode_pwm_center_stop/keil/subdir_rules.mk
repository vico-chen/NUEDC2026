...
TI学习/Examples/LP_MSPM0G3507/driverlib/timx_timer_mode_pwm_center_stop/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/timx_timer_mode_pwm_center_stop/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
