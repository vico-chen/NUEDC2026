...
TI学习/Examples/LP_MSPM0G3507/driverlib/uart_tx_hw_flow_control/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/uart_tx_hw_flow_control/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
