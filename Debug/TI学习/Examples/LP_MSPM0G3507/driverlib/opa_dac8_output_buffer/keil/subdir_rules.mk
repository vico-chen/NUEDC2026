...
TI学习/Examples/LP_MSPM0G3507/driverlib/opa_dac8_output_buffer/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/opa_dac8_output_buffer/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
