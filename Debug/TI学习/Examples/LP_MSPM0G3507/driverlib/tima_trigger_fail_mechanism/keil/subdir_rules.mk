...
TI学习/Examples/LP_MSPM0G3507/driverlib/tima_trigger_fail_mechanism/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/tima_trigger_fail_mechanism/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
