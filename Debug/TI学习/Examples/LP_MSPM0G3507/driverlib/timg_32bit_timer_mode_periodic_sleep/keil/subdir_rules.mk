...
TI学习/Examples/LP_MSPM0G3507/driverlib/timg_32bit_timer_mode_periodic_sleep/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/timg_32bit_timer_mode_periodic_sleep/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
