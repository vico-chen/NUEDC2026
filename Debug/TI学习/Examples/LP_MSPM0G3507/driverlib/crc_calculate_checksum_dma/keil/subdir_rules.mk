...
TI学习/Examples/LP_MSPM0G3507/driverlib/crc_calculate_checksum_dma/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/crc_calculate_checksum_dma/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
