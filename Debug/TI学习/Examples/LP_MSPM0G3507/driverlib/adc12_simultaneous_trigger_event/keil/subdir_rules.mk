...
TI学习/Examples/LP_MSPM0G3507/driverlib/adc12_simultaneous_trigger_event/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/adc12_simultaneous_trigger_event/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
