...
TI学习/Examples/LP_MSPM0G3507/driverlib/rtc_offset_calibration_lfxt/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/rtc_offset_calibration_lfxt/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
