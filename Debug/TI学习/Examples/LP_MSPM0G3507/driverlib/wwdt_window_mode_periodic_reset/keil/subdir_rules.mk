...
TI学习/Examples/LP_MSPM0G3507/driverlib/wwdt_window_mode_periodic_reset/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/wwdt_window_mode_periodic_reset/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
