...
TI学习/Examples/LP_MSPM0G3507/driverlib/wwdt_interval_timer_lfosc_standby/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/wwdt_interval_timer_lfosc_standby/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
