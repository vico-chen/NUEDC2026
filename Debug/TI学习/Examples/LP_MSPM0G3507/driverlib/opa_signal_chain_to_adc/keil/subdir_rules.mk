...
TI学习/Examples/LP_MSPM0G3507/driverlib/opa_signal_chain_to_adc/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/opa_signal_chain_to_adc/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
