...
TI学习/Examples/LP_MSPM0G3507/driverlib/uart_rx_hw_flow_control/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/uart_rx_hw_flow_control/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
...
TI学习/Examples/LP_MSPM0G3507/driverlib/uart_rx_hw_flow_control/uart_rx_hw_flow_control.opt: ../TI学习/Examples/LP_MSPM0G3507/driverlib/uart_rx_hw_flow_control/uart_rx_hw_flow_control.syscfg
	@echo 'SysConfig: "$<"'
	"C:/ti/ccs2100/ccs/utils/sysconfig_1.28.0/sysconfig_cli.bat" -s "C:/ti/mspm0_sdk_2_11_00_07/.metadata/product.json" -s "C:/ti/mspm0_sdk_2_11_00_07/.metadata/product.json" --script "C:/Users/Vico/Desktop/26NUEDC/Code/main/NUEDC2026/TI学习/Examples/LP_MSPM0G3507/driverlib/uart_rx_hw_flow_control/uart_rx_hw_flow_control.syscfg" -o "." --compiler ticlang
