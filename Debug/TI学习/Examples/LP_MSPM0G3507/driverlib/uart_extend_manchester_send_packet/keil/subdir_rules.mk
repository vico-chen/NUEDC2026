...
TI学习/Examples/LP_MSPM0G3507/driverlib/uart_extend_manchester_send_packet/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/uart_extend_manchester_send_packet/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
