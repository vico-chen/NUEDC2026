...
TI学习/Examples/LP_MSPM0G3507/driverlib/rtc_periodic_alarm_lfxt_standby/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/rtc_periodic_alarm_lfxt_standby/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
