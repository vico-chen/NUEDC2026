...
TI学习/Examples/LP_MSPM0G3507/driverlib/flashctl_nonmain_memory_write/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/flashctl_nonmain_memory_write/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
