...
TI学习/Examples/LP_MSPM0G3507/driverlib/flashctl_dynamic_memory_protection/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/flashctl_dynamic_memory_protection/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
