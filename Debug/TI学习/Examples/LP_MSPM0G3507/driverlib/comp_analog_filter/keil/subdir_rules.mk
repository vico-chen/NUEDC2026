...
TI学习/Examples/LP_MSPM0G3507/driverlib/comp_analog_filter/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/comp_analog_filter/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
