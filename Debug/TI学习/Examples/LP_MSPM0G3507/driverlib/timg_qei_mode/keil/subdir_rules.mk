...
TI学习/Examples/LP_MSPM0G3507/driverlib/timg_qei_mode/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/timg_qei_mode/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
