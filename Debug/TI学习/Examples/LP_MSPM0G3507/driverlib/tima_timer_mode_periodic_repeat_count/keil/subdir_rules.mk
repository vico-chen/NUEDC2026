...
TI学习/Examples/LP_MSPM0G3507/driverlib/tima_timer_mode_periodic_repeat_count/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/tima_timer_mode_periodic_repeat_count/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
