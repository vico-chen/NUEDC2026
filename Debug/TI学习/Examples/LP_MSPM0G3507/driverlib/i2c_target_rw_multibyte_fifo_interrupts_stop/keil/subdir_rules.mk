...
TI学习/Examples/LP_MSPM0G3507/driverlib/i2c_target_rw_multibyte_fifo_interrupts_stop/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/i2c_target_rw_multibyte_fifo_interrupts_stop/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
