...
TI学习/Examples/LP_MSPM0G3507/driverlib/opa_burnout_current_source_to_adc/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/opa_burnout_current_source_to_adc/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
