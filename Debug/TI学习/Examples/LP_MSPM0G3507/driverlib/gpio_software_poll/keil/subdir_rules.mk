...
TI学习/Examples/LP_MSPM0G3507/driverlib/gpio_software_poll/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/gpio_software_poll/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
