...
TI学习/Examples/LP_MSPM0G3507/driverlib/empty_driverlib_src/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/empty_driverlib_src/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
