...
TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_frequency_clock_counter/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/sysctl_frequency_clock_counter/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
