...
TI学习/Examples/LP_MSPM0G3507/driverlib/nvic_interrupt_disable/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/nvic_interrupt_disable/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
