...
TI学习/Examples/LP_MSPM0G3507/driverlib/opa_non_inverting_pga/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/opa_non_inverting_pga/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
