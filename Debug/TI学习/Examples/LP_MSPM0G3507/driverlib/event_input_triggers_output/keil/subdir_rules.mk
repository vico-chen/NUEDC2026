...
TI学习/Examples/LP_MSPM0G3507/driverlib/event_input_triggers_output/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/driverlib/event_input_triggers_output/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
