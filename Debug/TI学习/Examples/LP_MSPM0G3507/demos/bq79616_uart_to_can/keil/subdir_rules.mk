...
TI学习/Examples/LP_MSPM0G3507/demos/bq79616_uart_to_can/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/demos/bq79616_uart_to_can/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
