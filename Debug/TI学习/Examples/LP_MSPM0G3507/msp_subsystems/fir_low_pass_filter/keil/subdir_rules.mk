...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/fir_low_pass_filter/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/fir_low_pass_filter/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
