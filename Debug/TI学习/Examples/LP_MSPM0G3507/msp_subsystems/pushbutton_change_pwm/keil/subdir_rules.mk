...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/pushbutton_change_pwm/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/pushbutton_change_pwm/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
