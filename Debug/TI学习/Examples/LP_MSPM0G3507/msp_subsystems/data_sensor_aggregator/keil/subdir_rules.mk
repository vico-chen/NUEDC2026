...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/data_sensor_aggregator/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/data_sensor_aggregator/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
