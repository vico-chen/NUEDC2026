...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/adc_to_i2c_target/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/adc_to_i2c_target/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
