...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/High_Gain_Self_Compensating_ADC/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/High_Gain_Self_Compensating_ADC/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
