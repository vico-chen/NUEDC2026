...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/adc_dma_ping_pong/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/adc_dma_ping_pong/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
