...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/uart_to_i2c_bridge/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/uart_to_i2c_bridge/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
