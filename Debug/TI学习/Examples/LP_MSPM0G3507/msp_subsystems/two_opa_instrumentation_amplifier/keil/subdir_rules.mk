...
TI学习/Examples/LP_MSPM0G3507/msp_subsystems/two_opa_instrumentation_amplifier/keil/%.o: ../TI学习/Examples/LP_MSPM0G3507/msp_subsystems/two_opa_instrumentation_amplifier/keil/%.s $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Arm Compiler: "$<"'
